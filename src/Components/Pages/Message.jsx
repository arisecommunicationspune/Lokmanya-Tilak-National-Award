...
function Message() {
  return (
    ...
    <div className="container">
      <div className="image-section py-20">
      ...
      <div className="message-content">
        ...
        <p className="signature py-10">
          With warm regards and patriotic fervour,<br /><i>
          <strong>Dr. Rohit Deepak Tilak</strong><br />
          Trustee, Lokmanya Tilak Smarak Trust<br />
          Secretary, Lokmanya Tilak National Award Committee</i>
        </p>
      </div>
    </div>
    <NewsLetter/>
